...
<sup>This branch in particular is testing grounds for me and a change in approach to building the application.</sup>
...
- ~~Editor extensibility through [Lua](https://www.lua.org/about.html) scripting.~~ <sup>Wasm is just better for this use case...</sup>
