...
impl Renderer {
    pub fn new(window: &window::Window) -> Self {
        ...
        let main_surface = Self::create_main_surface(&instance, window);
        let adapter = Self::create_adapter(&instance, &main_surface);
    ...
    fn create_main_surface(
        ...
        // # Safety:
        // `main_window` has to live at least as long as `surface`.
        unsafe {
            instance
